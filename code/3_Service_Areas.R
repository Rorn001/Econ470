...
for (y in 2006:2015) {
  ...
  for (m in monthlist) {
    ...
    ma.path=paste0("C:/Users/huang/desktop/Econ470/monthly-ma-contract-service-area/MA_Cnty_SA_",y,"_",m,".csv")
...
write_csv(contract.service.area,"C:/Users/huang/desktop/Econ470/contract_service_area.csv")
